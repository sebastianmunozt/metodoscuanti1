...
#   prop.table(frecuencia_genero) * 100 y asignela a un objeto denominado "porcentajes_genero" (1 punto)


# 6. transforme esta tabla a data frame con la función as.data.frame(), el dataframe se debe seguir llamando porcentaje_genero
#es necesario convertir la tabla en dataframe para el gráfico. (1 punto)


# 7. realice un gráfico de barras usando el data frame porcentaje_genero (3 puntos)
