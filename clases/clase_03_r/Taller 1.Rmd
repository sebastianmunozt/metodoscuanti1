...
- Martes 29 de Agosto: Comenzamos con R
- Viernes 1 de Septiembre: Ayudantía: tener instalado R
- Martes 5 de Septiembre: Metodología [posibilidad de **tutorías**]
- Martes 12 de Septiembre: Seguimos con R
- Viernes 15 de Septiembre: Ayudantía
- Martes 19 de Septiembre: Feriado
- Viernes 22 de Septiembre: Posibilidad de Ayudantía: Pre-prueba
- Martes 26 de Septiembre: **Prueba** metodología + R
...
- Implicancias de la forma de trabajo: simplicidad, profundidad, generalidad
...
- *"es un foco de interés o una situación o fenómeno que se desea conocer más o que ha despertado nuestra curiosidad por motivos problamente extra-académicos"*
...
Llenarlo [aquí](https://docs.google.com/document/d/1YYB5lue-XZKj0flSBVlG15RuvhVZn06dfGGqAqfP1Is/edit).


---
## En Rúbrica para trabajo


Formulación (20 puntos)
...
- Abramos el R Studio
- Abramos el **proyecto** que dice Taller 1
- Carguemos **el archivo** que dice Taller 1.RMD
- Carguemos **script de r** clase 1.R
- Hagamos Knit en Taller 1.RMD
- eliminar el #install.packages("xaringanthemer") (si es necesario)
