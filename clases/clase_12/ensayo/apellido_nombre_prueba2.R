# Prueba 2. VERSIÓN C - Métodos Cuantitativos en R
...
# cree una base en donde realice un filtro, que permita quedarse sólo con los estudiantes que se perciben que estudiaron en: 
# Particular subvencionado y Público
# esto es contestaron: "Particular subvencionado" y "Público" en la variable "tipo_colegio_e" 
# a esta nueva base pongale estudiantes_colegios (2 puntos)
...
ggplot(data =_________, aes(x = _________, y =_______, fill = ___________)) +
  geom_bar(stat = "identity", fill = "blue") +
  theme(axis.text.x = element_text(angle = 70, hjust = 1)) +
  labs(title = "Gráfico de Barras de_______", x = "_________", y = "______") +
